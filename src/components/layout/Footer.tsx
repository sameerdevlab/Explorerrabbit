...
const Footer: React.FC<FooterProps> = ({ onAboutClick, onTermsClick, onSupportClick }) => {
  ...
  return (
    <footer className="bg-gradient-to-t from-gray-900 via-purple-600 via-gray-500 to-gray-400 dark:from-gray-950 dark:via-purple-950 dark:to-gray-800 text-white py-12 px-6">
