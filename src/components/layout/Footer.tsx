...
const Footer: React.FC<FooterProps> = ({ onAboutClick, onTermsClick, onSupportClick }) => {
  ...
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-purple-900 to-gray-900 dark:from-gray-950 dark:via-purple-950 dark:to-gray-950 text-white py-12 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <img 
                className="w-10 h-12 rounded-xl bg-gradient-to-r from-gray-900 via-white-300 to-gray-100" 
