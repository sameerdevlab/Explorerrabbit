...
const Footer: React.FC<FooterProps> = ({ onAboutClick, onTermsClick, onSupportClick }) => {
  ...
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-purple-900 to-gray-900 dark:from-gray-950 dark:via-purple-950 dark:to-gray-950 text-white py-12 px-6 mt-16">
