          ...
          {user ? (
            <div className="relative">
              <div className="flex items-center gap-4">
                ...
                <div className="absolute right-0 top-full mt-1 opacity-0 group-hover:opacity-100 transition-all duration-4000 transform translate-y-2 group-hover:translate-y-0 pointer-events-none group-hover:pointer-events-auto">
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => signOut()}
