    ...
    <div className="flex justify-center mb-8">
      <div className="relative bg-white/20 dark:bg-gray-800/20 backdrop-blur-md p-1 rounded-lg flex shadow-lg">
        ...
        >
          ...
          {mode === 'generate' && (
            <motion.div
              className="absolute inset-0 bg-white40 dark:bg-gray-700 rounded-md shadow-sm"
              layoutId="pill"
              initial={false}
        ...
        >
          ...
          {mode === 'paste' && (
            <motion.div
              className="absolute inset-0 bg-white/40 dark:bg-gray-700 rounded-md shadow-sm"
              layoutId="pill"
              initial={false}
              transition={{ type: "spring", duration: 0.5 }}
            />
