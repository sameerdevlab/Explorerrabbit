  ...
  ({ className, icon, variant = 'default', error, glowing = false, ...props }, ref) => {
    return (
      <div className="relative w-full">
        ...
        <input
          className={cn(
            'w-full px-4 py-2 text-gray-700 bg-white border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all relative z-10',
            {
              'pl-10': icon,
