...
import { X, FileText, Calendar, Loader2, Bookmark, Trash2, AlertTriangle, Download } from 'lucide-react';
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {savedContent.length > 0 && (
                        <Button
                          ...
                          variant="sketchy"
                          className="bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white border-none shadow-lg"
                        >
