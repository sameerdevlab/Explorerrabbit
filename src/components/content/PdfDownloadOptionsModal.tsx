...
const PdfDownloadOptionsModal: React.FC<PdfDownloadOptionsModalProps> = ({
  ...
  const handleDownloadPdf = async () => {
    ...
    const loadingToastId = toast.loading(`Generating PDF with ${filteredContent.length} items..., Please wait until PDF gets download`);
              ...
              <CardContent className="p-6">
                ...
                {savedContent.length === 0 ? (
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6 bg-green-500">
