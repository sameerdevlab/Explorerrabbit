  ...
  return (
    <>
        ...
        <Card className="bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 dark:from-gray-800 dark:via-blue-900/20 dark:to-purple-900/20 shadow-2xl border-2 border-blue-200/50 dark:border-blue-700/50">
          <CardContent className="p-6">
            ...
            {mcqGenerationStatus === 'generating' || isGeneratingMcqs ? (
              ...
              // Initial state - Show Generate Quiz button
              <motion.div 
                className="text-center py-12 bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 rounded-2xl border-2 border-blue-200 dark:border-blue-700"
              ...
              >
                <motion.div
                  ...
                  className="mb-6"
                >
                  <div className="p-6 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full shadow-2xl mx-auto w-fit">
                ...
                <Button 
                  ...
                  variant="sketchy"
                  className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white border-none shadow-lg text-lg py-3 px-8"
                >
      ...
      <div
        ...
        className="absolute left-[-9999px] top-[-9999px] w-[800px] h-[1200px] grid grid-cols-2 gap-6 bg-white p-8 font-sans"
        style={{ display: '' }}
      >
        {currentMcqs && currentMcqs.length > 0 && quizCompleted && (
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              {currentMcqs.slice(0, 3).map((mcq, index) => {
        ...
        {mcq.options.map((option, i) => {
          ...
          return (
            ...
            <div className="text-center pt-6 border-t-2 border-gray-200">
              <p className="text-gray-600">Generated by Explorer</p>
